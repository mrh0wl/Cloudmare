...
from lib.parse.settings import checkImports
...
from lib.parse.settings import BASIC_HELP
from lib.parse.settings import logotype, COPYRIGHT, VERSION, PYVERSION, NAME
from lib.parse.colors import G, W, Y, bad, info
from lib.core.defaults import defaults
