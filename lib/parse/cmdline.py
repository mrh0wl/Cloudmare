...
from lib.parse.settings import logotype, COPYRIGHT, VERSION, NAME
...
def parse_args():
	...
	parser1.add_argument("-c", "--censys", help="search ips using censys.io", action="store_true", default=False)
