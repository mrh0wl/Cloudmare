...
if LXML_PRESENT:
    from thirdparty.bs4.builder import LXMLTreeBuilder, LXMLTreeBuilderForXML

from thirdparty.bs4 import (
    BeautifulSoup,
    BeautifulStoneSoup,
    )
from thirdparty.bs4.element import Comment, Doctype, SoupStrainer
from thirdparty.bs4.testing import skipIf
from thirdparty.bs4.tests import test_htmlparser
from thirdparty.bs4.testing import (
